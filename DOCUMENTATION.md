...
|------|---------------|
| Header buffer | 8 |
| Data buffer | variable (188 x the amount of particles excluding particle names) |
...
|--------------|-----------|---------|-------|
| `04000000` | ? | ? | ? |
| `6F000000` | 32-bit unsigned integer | Particle amount | 111 |
...
| Binary (hex) | Data type | Meaning | Value |
|--------------|-----------|---------|-------|
| `626C6F6F64` | String | Particle name | `blood` |
| `63656E746970656465627572726F77` | String | Particle name | `centipedeburrow` |
