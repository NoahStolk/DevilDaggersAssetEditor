...
{
	public static string GetSubfolderName(this BinaryType binaryType) => binaryType switch
	{
	...
	public static string GetFolderName(this AssetType assetType) => assetType switch
	{
	...
	public static (byte R, byte G, byte B) GetColor(this AssetType assetType) => assetType switch
	{
	...
	public static AssetType? GetAssetType(this string fileExtension) => fileExtension switch
	{
		".wav" => AssetType.Audio,
		".ini" => AssetType.Audio,
	...
	public static AssetType? GetAssetType(this byte binaryType) => binaryType switch
	{
