...
namespace DevilDaggersAssetEditor.Wpf
{
	public partial class App : Application
	{
		...
		public static Version LocalVersion { get; } = Version.Parse(FileVersionInfo.GetVersionInfo(Path.Combine(AppContext.BaseDirectory, $"{ApplicationName}.Wpf.exe")).FileVersion ?? throw new("Could not get file version from current assembly."));
